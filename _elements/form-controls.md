...
<div class="usa-accordion-bordered usa-accordion-docs">
  ...
  <div id="collapsible-0" aria-hidden="false" class="usa-accordion-content">
    ...
    <h5>When to use</h5>
    <ul class="usa-content-list">
      <li>Usei chosen plugin when there are more than 25 options in a dropdown or when the data is grouped.</li>
    </ul>
    <h5>When to consider something else</h5>
    <ul class="usa-content-list">
      <li>When the select menu is 25 items or less use of the chosen plugin is not warranted.</li>
    </ul>
  </div>
</div>
