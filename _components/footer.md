...
<h6 class="usa-heading-alt">Interim Version 1 (5.5.1 to 5.6.1)</h6>
<div class="preview">
...
<div class="usa-accordion-bordered usa-accordion-docs">
  ...
  <div id="collapsible-0" aria-hidden="false" class="usa-accordion-content">
    ...
    <ul class="usa-content-list">
      ...
      <li>This version should be used until we deploy the revised signed-in home page (Profile Dashboard).</li>
    </ul>
...
<h6 class="usa-heading-alt">Interim Version 1 (5.5.1 to 5.6.1) - Job Announcement variation</h6>
<div class="preview">
  <footer class="usa-footer usa-footer-big usajobs-footer--v1" role="contentinfo" aria-label="footer" data-object="footer">
    <div class="usa-grid usa-footer-return-to-top">
      <a href="#footer">Return to top</a>
